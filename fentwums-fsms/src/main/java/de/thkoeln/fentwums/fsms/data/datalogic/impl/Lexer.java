 ...
 * Class:       Lexer
 * Created:     2011-11-18
 * modified for Simulator: 2018-01
 * by Markus de Koster, Linus Schöndorf, Marvin Jolk
 */
package de.thkoeln.fentwums.fsms.data.datalogic.impl;

/**
 * Acts as tokenizer. An input-string (ASCII) is split into tokens that can be
 * used by a parser.
 *
...
public class Lexer {
    ...
    /**
     * reads the next (ASCII-)character from the input-string and stores it into
    ...
    /**
     * Get the next token from the input-string the result will be stored in the
     * attribute "token". (It is not returned for easier parser-implementation)
     *
     * @author Andreas Schwenk
     */
    public void getNextToken() {
        ...
        //modified for Simulation - should use # sign to distinguish from MINUS and DECREMENT
     ...
     *
     * @param str string that shall be lexed
     *
     * @author Andreas Schwenk
     */
