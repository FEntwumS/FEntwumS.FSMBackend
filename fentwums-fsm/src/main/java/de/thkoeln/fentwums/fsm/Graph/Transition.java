...
import de.thkoeln.fentwums.fsm.AdditionalMath.AdditionalMath;
import de.thkoeln.fentwums.fsm.Generation.ConditionParser.GeneratedCondition;
import de.thkoeln.fentwums.fsm.Generation.OutputVectorParser.GeneratedOutputVector;
import de.thkoeln.fentwums.fsm.Gui.CustomTextField;
import de.thkoeln.fentwums.fsm.Gui.GraphicsPanel;
...
public class Transition extends Component
{
    ...
    /**
     * gets the Start Node Start Position
     * 
     * @return position as a Point
     * 
     * @author Markus de Koster
     */
    public Point getStartNodeStartPos() {
        return this.startNodeStartPos;
    }
    
    /**
     * gets the Docking Point Index of toState
     * 
     * @return position as a Point
     * 
     * @author Markus de Koster
     */
    public int getToStateDockingPointIndex() {
        return this.toState.dockingPointIndex;
    }
     ...
     * @author Markus de Koster
     */
    public Point getToStateDockingPoint() {
        double x = toState.state.getPosition().x + (int)(((double)toState.state.getSize().x/2.0)
        * Math.cos(2.0*Math.PI/12.0*(double)toState.dockingPointIndex));
        double y = toState.state.getPosition().y + (int)(((double)toState.state.getSize().x/2.0)
        * Math.cos(2.0*Math.PI/12.0*(double)toState.dockingPointIndex));
    ...
    /**
     * gets the Docking Point Index of fromState
     * 
     * @return position as a Point
     * 
     * @author Markus de Koster
     */
    public Point getFromStateDockingPoint() {
        double x = toState.state.getPosition().x + (int)(((double)fromState.state.getSize().x/2.0)
        * Math.cos(2.0*Math.PI/12.0*(double)fromState.dockingPointIndex));
        double y = toState.state.getPosition().y + (int)(((double)fromState.state.getSize().x/2.0)
        * Math.cos(2.0*Math.PI/12.0*(double)fromState.dockingPointIndex));
        Point p = new Point((int)x, (int)y);
        return p;
    }
    ...
    /**
     * get List of ControlPoints
     * 
     * @return LinkedList of ControlPoints
     * 
     * @author Markus de Koster
     */
    public LinkedList<Point> getCtrlPoints()
    {
        return ctrlPoints;
    }
    /**
     * get Relative Condition Position
     * 
     * @return relativeConditionPosition
     * 
     * @author Markus de Koster
     */
