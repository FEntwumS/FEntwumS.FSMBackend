...
import de.thkoeln.fentwums.fsm.gui.boundary.GuiTableBoundary;
...
public class GuiTableSignals extends JPanel
{
    ...
    class ButtonRenderer extends DeleteButton implements TableCellRenderer
    {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value,
                boolean isSelected, boolean hasFocus, int row, int column)
            {
                ...
                {
                    setIcon(ResourceLoader.loadImageIcon("tableDeleteRolloverIcon"));
                }
                else if (row == selectedRowNumber)
                {
                    setIcon(ResourceLoader.loadImageIcon("tableDeleteIcon"));
                }
                else
                {
                    setIcon(ResourceLoader.loadImageIcon("tableDeleteEmptyIcon"));
                }
    ...
    public class DeleteButton extends JButton
    {
       public DeleteButton()
       {
           ...
           setRolloverIcon(ResourceLoader.loadImageIcon("tableDeleteRolloverIcon"));
           setPressedIcon(ResourceLoader.loadImageIcon("tableDeletePressedIcon"));
           setDisabledIcon(ResourceLoader.loadImageIcon("tableDeleteIcon"));
           setSelectedIcon(ResourceLoader.loadImageIcon("tableDeleteRolloverIcon"));
           setDisabledSelectedIcon(ResourceLoader.loadImageIcon("tableDeleteIcon"));
           setIcon(ResourceLoader.loadImageIcon("tableDeleteEmptyIcon"));
